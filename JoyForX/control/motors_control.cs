...
{
    class motors_control : MWGUIControl
    {
        #region Fields
        ...
        static int[,] coord_quadX = {  { 121, 169, 69 },{ 121, 79, 69 },{ 41, 169, 69 },{ 41, 79, 69 }  };
        static int[,] coord_quadP = { { 76, 179, 69 }, { 126, 129, 69 }, { 26, 129, 69 }, { 76, 79, 69 } };
        static int[,] coord_tri = { { 71, 129, 69 },  { 121, 79, 69 },{ 21, 79, 69 }, { 41, 161, 69 } };
        ...
        static int[,] coord_hex6 = { { 121, 169, 69 }, { 120, 90, 70 }, { 20, 170, 70 }, { 20, 90, 70 }, { 70, 80, 70 }, { 70, 180, 70 } };
        static int[,] coord_hex6x = { { 101, 179, 69 }, { 101, 79, 69 }, { 61, 179, 69 }, { 61, 79, 69 }, { 141, 129, 69 }, { 21, 129, 69 } };
        ...
        static CopterType CopterTypeToDraw = CopterType.QuadX;
        ...
        Bitmap bmpQuadX = new Bitmap(JoyForX.UI.control.Resource1.quadx1);
        Bitmap bmpQuadP = new Bitmap(JoyForX.UI.control.Resource1.quadp1);
        Bitmap bmpTri = new Bitmap(JoyForX.UI.control.Resource1.tri1);
        Bitmap bmpY6 = new Bitmap(JoyForX.UI.control.Resource1.y61);
        Bitmap bmpY4 = new Bitmap(JoyForX.UI.control.Resource1.y41);
        Bitmap bmpBi = new Bitmap(JoyForX.UI.control.Resource1.bicopter1);
        Bitmap bmpHex6 = new Bitmap(JoyForX.UI.control.Resource1.hex61);
        Bitmap bmpHex6X = new Bitmap(JoyForX.UI.control.Resource1.hex6x1);
        Bitmap bmpFw = new Bitmap(JoyForX.UI.control.Resource1.fw1);
        Bitmap bmpGimbal = new Bitmap(JoyForX.UI.control.Resource1.gimbal1);
        Bitmap bmpOcto8x = new Bitmap(JoyForX.UI.control.Resource1.octo8x1);
        Bitmap bmpOcto8p = new Bitmap(JoyForX.UI.control.Resource1.octo8p1);
        Bitmap bmpOcto8c = new Bitmap(JoyForX.UI.control.Resource1.octo8coax1);
        Bitmap bmpAirplane = new Bitmap(JoyForX.UI.control.Resource1.airplane1);
        Bitmap bmpHeli120 = new Bitmap(JoyForX.UI.control.Resource1.heli_1201);
        Bitmap bmpHeli90 = new Bitmap(JoyForX.UI.control.Resource1.heli_901);
        Bitmap bmpVtail = new Bitmap(JoyForX.UI.control.Resource1.vtail1);
            ...
            switch (CopterTypeToDraw)
            {
                ...
                case CopterType.Hex6X:
                    ...
                    for (i = 0; i < 6; i++)
                    {
                        ...
                        if (i > 3) { pe.Graphics.DrawString(String.Format("{0:0}", motorvals[i]), drawFont, drawBrush, coord_hex6x[i, 0] - 12, coord_hex6x[i, 1] + 10); }
                        else { pe.Graphics.DrawString(String.Format("{0:0}", motorvals[i]), drawFont, drawBrush, coord_hex6x[i, 0] -12, coord_hex6x[i, 1] + 10); }
                    }
                    break;
